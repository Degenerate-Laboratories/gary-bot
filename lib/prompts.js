...
exports.USER_TWEET_RESPONSE_PROMPT = exports.USER_TWEET_PROMPT = exports.USER_JOINED_PROMPT = exports.USER_RAID_PROMPT = exports.SYSTEM_TAUNT_DEAD = exports.SYSTEM_SUBTLE_AD = exports.SYSTEM_NO_SEC_HASHTAG = exports.SYSTEM_KNOWN_HANDLES = exports.SYSTEM_ENEMIES_INFO = exports.SYSTEM_CLUBMOON_BACKSTORY = exports.SYSTEM_TALK_CRAP = exports.SYSTEM_ROAST_WALLET = exports.SYSTEM_ROAST_PLAYER = exports.SYSTEM_ROAST_PLAYER_ATTACKING = exports.SYSTEM_ONE_SENTENCE_PROMPT = exports.SYSTEM_GARY_PROMPT = exports.TROLL_DEFENSE = void 0;
exports.TROLL_DEFENSE = {
    role: "user",
...
exports.SYSTEM_ONE_SENTENCE_PROMPT = {
    role: "system",
    content: "only create responses with 1 short sentences"
};
exports.SYSTEM_ROAST_PLAYER_ATTACKING = {
    role: "system",
...
exports.SYSTEM_CLUBMOON_BACKSTORY = {
    role: "system",
...
const USER_RAID_PROMPT = (payload) => ({
    role: "user",
    content: `Raid event ${payload}.`
});
exports.USER_RAID_PROMPT = USER_RAID_PROMPT;
// Example user message prompts
const USER_JOINED_PROMPT = (payload) => ({
    role: "user",
    content: `Generate a greeting for a player named ${payload}.`
});
exports.USER_JOINED_PROMPT = USER_JOINED_PROMPT;
exports.USER_TWEET_PROMPT = {
    role: "user",
...
exports.USER_TWEET_RESPONSE_PROMPT = {
    role: "user",
